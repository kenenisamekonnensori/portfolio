    ...
    return (
        <section id="about" className="py-24 px-6 md:px-20 bg-[radial-gradient(circle_at_30%_20%,#141414,transparent_35%),linear-gradient(160deg,#080808,#0e0e12)] flex flex-col md:flex-row gap-12 md:gap-24">
            <div className="md:w-1/3">
                <h2 className="text-3xl md:text-5xl font-display font-bold uppercase sticky top-32">
                    About Me
                </h2>
            </div>

            <div className="md:w-2/3 flex flex-col gap-4">
                <h3 className="text-2xl md:text-3xl font-display font-bold leading-tight text-muted">
                ...
                <p className="text-lg text-muted leading-relaxed max-w-1xl">
